...
<body>
    ...
    <nav>
        <div class="container nav__container">
            <a href="index.html" class="nav__logo">RONALDO</a>
            <ul class="nav__items">
            ...
            <article class="post">
                ...
                <div class="post__info">
                    ...
                    <h3 class="post__title">
                        <a href="post.html">Lorem ipsum dolor sit amet consectetur adipisicing elit cum.</a>
                    </h3>
                    <p class="post__body">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloremque, adipisci recusandae
                        blanditiis ex facilis quam error praesentium ut culpa laboriosam.
                    </p>
    ...
    <footer>
        ...
        <div class="footer__copyright">
            <small>Copyright &copy; RONALDO 2023</small>
        </div>
    </footer>
